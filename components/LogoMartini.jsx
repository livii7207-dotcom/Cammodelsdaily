export default function LogoMartini({ size = 'md', showText = false }) {
  ...
  return (
    <svg width={w} height={h} viewBox={`0 0 160 ${showText ? 300 : 260}`} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* ── Pink neon glow outline (pulsing) ── */}
      ...
      {/* Body — bowl of glass = upper body, stem = waist, base = hips */}
      <path
        d="M 22 70 Q 80 62 138 70 L 100 156 Q 80 162 60 156 Z"
        fill="url(#mg-blue)"
      />
      {/* Neck */}
      ...
      {/* Base / hips */}
      <path
        d="M 32 216 Q 80 208 128 216 L 130 232 Q 80 240 30 232 Z"
        fill="url(#mg-blue)"
      />
      ...
      {/* Right eye — wink (closed with lashes) */}
