export default function Logo({ size = 'md' }) {
  ...
  return (
    <svg width={w} height={h} viewBox="0 0 210 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Center diamond — where the two strokes cross */}
      <path d="M 19 16.5 L 22 19 L 19 21.5 L 16 19 Z" fill="white" opacity="0.75" />

      {/* ── Two tasteful gold sparkles ── */}
      ...
      {/* "Models" — gradient, lighter weight, spaced */}
      <text x="106" y="27"
        fontFamily="Sora, sans-serif"
        fontWeight="500"
        fontSize="22"
